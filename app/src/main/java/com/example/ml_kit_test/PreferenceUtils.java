...
import com.example.ml_kit_test.CameraSource.SizePair;
...
public class PreferenceUtils {
    ...
    @Nullable
    public static com.example.ml_kit_test.CameraSource.SizePair getCameraPreviewSizePair(Context context, int cameraId) {
